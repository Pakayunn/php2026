                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['totalBrands'] }}</div>
                        </div>
                        <div class="col-auto">
...
<script>
// Data from PHP
const categoryData = @json($chartData['productsByCategory']);
const brandData = @json($chartData['productsByBrand']);
