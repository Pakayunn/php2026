...
<?php $__env->startSection('title', $product['name'] . ' - PHP2 MVC Shop'); ?>
        ...
        <div class="product-detail">
            ...
            <div class="product-image-section">
                <div class="image-container">
                    ...
                    <?php else: ?>
                        <img src="https://via.placeholder.com/600x600/e5e7eb/666666?text=No+Image" alt="<?php echo e($product['name']); ?>">
                    <?php endif; ?>
            ...
            <div class="product-info-section">
                <div class="category-badge"><?php echo e($product['category_name'] ?? 'Chưa phân loại'); ?></div>
                ...
                <div class="product-price">
                    ...
                    <span class="original-price"><?php echo e(number_format($product['price'] * 1.2, 0, ',', '.')); ?>đ</span>
                ...
                <div class="product-meta">
                    <div class="meta-row">
                        ...
                        <span><?php echo e($product['brand_name'] ?? 'N/A'); ?></span>
                    </div>
                    <div class="meta-row">
                        <strong>Tồn kho:</strong>
                        <span><?php echo e($product['stock'] ?? 0); ?> sản phẩm</span>
                    </div>
                    <div class="meta-row">
                ...
                <div class="product-description">
                    ...
                    <p><?php echo e($product['description'] ?? 'Sản phẩm chất lượng cao, đảm bảo nguồn gốc xuất xứ rõ ràng.'); ?></p>
                </div>
        ...
        <div class="product-tabs">
            ...
            <div class="tabs-content">
                <div class="tab-pane active" id="description">
                    ...
                    <p><?php echo e($product['description'] ?? 'Đang cập nhật...'); ?></p>
                    <ul>
                ...
                <div class="tab-pane" id="specs">
                    <table class="specs-table">
                        <tr>
                            <th>Mã sản phẩm</th>
                            <td>SP<?php echo e(str_pad($product['id'], 6, '0', STR_PAD_LEFT)); ?></td>
                        </tr>
                        <tr>
                            <th>Danh mục</th>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Xamppp2\htdocs\hihi\php2026\PHP2_MVC\app\views/home/detail.blade.php ENDPATH**/ ?>