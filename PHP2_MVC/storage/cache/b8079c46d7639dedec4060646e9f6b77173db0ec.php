        ...
        <div class="row">
            ...
            <div class="col-md-2 p-0 sidebar">
                <nav class="nav flex-column mt-3">
                    <a class="nav-link <?php echo e(strpos($_SERVER['REQUEST_URI'], '/admin') !== false ? 'active' : ''); ?>" href="/admin">
                        <i class="fas fa-tachometer-alt"></i> Dashboard
                    </a>
                    <a class="nav-link <?php echo e(strpos($_SERVER['REQUEST_URI'], '/product') !== false ? 'active' : ''); ?>" href="/product">
                        <i class="fas fa-box"></i> Sản phẩm
                    </a>
                    <a class="nav-link <?php echo e(strpos($_SERVER['REQUEST_URI'], '/category') !== false ? 'active' : ''); ?>" href="/category">
                        <i class="fas fa-list"></i> Danh mục
                    </a>
                    <a class="nav-link <?php echo e(strpos($_SERVER['REQUEST_URI'], '/brand') !== false ? 'active' : ''); ?>" href="/brand">
                        <i class="fas fa-tags"></i> Thương hiệu
                    </a>
                    <a class="nav-link <?php echo e(strpos($_SERVER['REQUEST_URI'], '/user') !== false ? 'active' : ''); ?>" href="/user">
...
</html><?php /**PATH C:\Xamppp2\htdocs\Php2\PHP2_MVC\app\views/layouts/master.blade.php ENDPATH**/ ?>