...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - PHP2 MVC'); ?></title>
        ...
        <div class="row">
            ...
            <div class="col-md-2 p-0 sidebar">
                <nav class="nav flex-column mt-3">
                    <a class="nav-link <?php echo e(strpos($_SERVER['REQUEST_URI'], '/admin') !== false && strpos($_SERVER['REQUEST_URI'], '/admin/profile') === false ? 'active' : ''); ?>"
                        href="/admin">
...
<?php /**PATH C:\Xamppp2\htdocs\hi\php2026\PHP2_MVC\app\views/layouts/admin.blade.php ENDPATH**/ ?>